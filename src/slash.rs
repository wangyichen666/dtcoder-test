...
const COMMANDS: &[SlashCommand] = &[
    ...
    SlashCommand {
        name: "subagents",
        aliases: &[],
        help: "列出 root run 的子 Agent",
        usage: "/subagents <root_run_id>",
        args: ArgSpec::AtLeastOne("root run ID"),
    ...
    SlashCommand {
        ...
        aliases: &[],
        help: "读取指定子 Agent",
        usage: "/subagent <parent_run_id> <child_run_id>",
        args: ArgSpec::AtLeastOne("父和子 run ID"),
        action: SlashAction::Subagent,
    },
    SlashCommand {
        name: "subagent-wait",
        aliases: &[],
        help: "等待子 Agent 终态",
        usage: "/subagent-wait <parent_run_id> <child_run_id> [timeout_ms]",
        args: ArgSpec::AtLeastOne("父和子 run ID"),
        action: SlashAction::SubagentWait,
    },
    SlashCommand {
        name: "subagent-cancel",
        aliases: &[],
        help: "取消指定子 Agent",
        usage: "/subagent-cancel <parent_run_id> <child_run_id>",
        args: ArgSpec::AtLeastOne("父和子 run ID"),
        action: SlashAction::SubagentCancel,
    },
    SlashCommand {
        name: "sessions",
        aliases: &[],
